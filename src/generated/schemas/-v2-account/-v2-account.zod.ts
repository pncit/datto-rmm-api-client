...
export const CreateAccountVariableResponse = zod.void()
...
export const UpdateAccountVariableResponse = zod.void()
...
export const DeleteAccountVariableResponse = zod.void()
...
export const GetUserAccountResponse = zod.object({
  ...
  "numberOfOnDemandDevices": zod.int().optional(),
  "numberOfManagedDevices": zod.int().optional()
...
export const GetDnetSiteMappingsResponse = zod.object({
  ...
  "name": zod.string().optional(),
  "description": zod.string().optional(),
  "dattoNetworkingNetworkIds": zod.array(zod.int()).optional(),
  "portalUrl": zod.string().optional()
...
export const GetUserAccountDevicesQueryParams = zod.strictObject({
  "page": zod.int().optional(),
  "max": zod.int().optional(),
  "filterId": zod.int().optional().describe('Optional. If applied, this filter exclusively determines the results.'),
